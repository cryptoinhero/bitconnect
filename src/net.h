...
/** bitconnect: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // bitconnect: known sent sync-checkpoint
    ...
    // bitconnect: used to detect branch switches
