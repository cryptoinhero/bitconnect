...
static const CAmount MIN_TX_FEE = CENT / 100;
static const CAmount PERKB_TX_FEE = 10000;
static const CAmount MIN_TXOUT_AMOUNT = CENT;
static const CAmount MAX_MINT_PROOF_OF_WORK = 9999 * COIN;
static const std::string CURRENCY_UNIT = "BCC";
 ...
 * */
static const CAmount MAX_MONEY = 28019323 * COIN;
