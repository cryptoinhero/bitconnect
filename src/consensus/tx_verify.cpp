...
bool CheckTransaction(const CTransaction& tx, CValidationState &state, bool fCheckDuplicateInputs)
{
    ...
    for (const auto& txout : tx.vout)
    {
        ...
        // bitconnect: enforce minimum output amount
...
bool Consensus::CheckTxInputs(const CTransaction& tx, CValidationState& state, const CCoinsViewCache& inputs, int nSpendHeight, CAmount& txfee, uint64_t& nCoinAge, const Consensus::Params& params)
{
    ...
    else
    {
        ...
        // bitconnect: enforce transaction fees for every block
        txfee = txfee_aux;
    }
    return true;
}
