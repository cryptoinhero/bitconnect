...
// bitconnect
    // bitconnect: money supply related block index fields
    int64_t nMint;
    int64_t nMoneySupply;

    // bitconnect: proof-of-stake related block index fields
    unsigned int nFlags;  // bitconnect: block index flags
    enum
    {
