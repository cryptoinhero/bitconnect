...
const char * const BITCOIN_CONF_FILENAME = "bitconnect.conf";
const char * const BITCOIN_PID_FILENAME = "bitconnectd.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/bitconnect";
#else
    // Unix
