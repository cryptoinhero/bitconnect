...
* bitconnect.conf: contains configuration settings for bitconnectd or bitconnect-qt
* bitconnectd.pid: stores the process id of bitconnectd while running
...
* debug.log: contains debug information and general logging generated by bitconnectd or bitconnect-qt
